...
//    }
    ...
    public void iRefreshPageGoBackGoForward() {
    ...
    public void iChangeResulutionTo(String layout) {
        switch (layout) {
            case "phone":
...
//        getDriver().findElement(By.xpath("//*[@name='email']")).sendKeys("correct@format.com");
    ...
    @And("I type {string} in to email field")
    ...
    public void elementWithTextShouldBeDisplayed(String message) {
       ...
       assertThat(message.equals(errorMessage));
    }
    ...
    public void iNavigateToEnvironment(String env) {
        switch (env){
            case "qa":
                TestContext.getDriver().get("http://quote-qa.pornov.com/");
                break;
            case "stage":
                TestContext.getDriver().get("http://quote-stage.pornov.com/");
                break;
            case "prod":
                TestContext.getDriver().get("https://skryabin.com/market/quote.html");
                break;
